        ...
        return (
            <div>
                <article>
                    ...
                    <div id="content">
                        <ul id="slider">
                            <li className="slide showing"><img src="Picture/gt3.jpg" width="620px" height="240px" alt="gt3"/></li>
                            <li className="slide"><img src="Picture/gt2.jpg" width="620px" height="240px" alt="gt 2"/></li>
                            <li className="slide"><img src="Picture/gt4.jpeg" width="620px" height="240px" alt="gt 1"/></li>
                        </ul>
                    </div>
                    <br />
                    ...
                    <div align="justify">
                        ...
                        <br />
                        <div style={{ marginLeft: '20px' }}> <div className="hd5">Với kinh nghiệm hơn 5 năm về lĩnh vực đồ cũ tại thành phố
                            ...
                            <br />
                            <br />
                        </div><div style={{ marginLeft: '20px' }}><div className="hd4">Các Sản phẩm chúng tôi đang phân phối trên thị
                            trường hiện nay luôn đáp ứng các tiêu chí:</div></div><br />
                        </div>
